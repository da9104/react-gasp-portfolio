export const projects = [
    ...
    },
    {
      ...
      src: "images/screen1.gif",
      body: [
        { content: '1. 유저 블로그 포스트 생성, 삭제, 수정, 읽기 기능 구현. MongoDB로 DB를 저장하는 백엔드 서버 구축.'},
        { content: '2. 유저 아바타와 포스트 이미지 업로드 기능 가능.'},
        { content: '3. Socket.io를 이용하여 웹 앱 간 사용자 리얼 타임 채팅 가능.'},
      ],
